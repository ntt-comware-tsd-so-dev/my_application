...
public class DeviceDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        TextView titleView = (TextView)view.findViewById(R.id.device_name);
        titleView.setText(_device.toString());

        if ( _device != null ) {
            ImageView deviceImage = (ImageView) view.findViewById(R.id.device_image);
            deviceImage.setImageDrawable(_device.getDeviceDrawable(getActivity()));
        }
