...
AYLA_BUILD_BRANCH=${AYLA_BUILD_BRANCH:-release/5.3.01} # Internal use during porting only
AYLA_SDK_BRANCH=${AYLA_SDK_BRANCH:-release/5.3.01} # Internal use during porting only
AYLA_CORE_BRANCH=${AYLA_CORE_BRANCH:-release/5.3.01} # Internal use during porting only
